...
class ShowTicketsFrame(BaseFrame):
    ...
    def create_widgets(self, controller):
        ...
        self.tickets_label = tk.CTkLabel(self, text="У вас пока нет билетов", font=("Arial Bold", 20))
        ...
        self.timetable_button_submit = tk.CTkButton(self, text="Возврат билетов", fg_color="#FF6347",
                                                    font=("Arial Bold", 15),
