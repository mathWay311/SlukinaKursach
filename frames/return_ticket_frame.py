...
class ReturnTicket(BaseFrame):
    ...
    def create_widgets(self, controller):
        ...
        self.return_ticket_main_window_label_surname = tk.CTkEntry(self, width=150)
        self.return_ticket_main_window_label_surname.pack()
        ...
        self.return_ticket_main_window_label_name = tk.CTkEntry(self, width=150)
        self.return_ticket_main_window_label_name.pack()
        ...
        self.return_ticket_main_window_label_patronymic = tk.CTkEntry(self, width=150)
        self.return_ticket_main_window_label_patronymic.pack()
        ...
        self.return_ticket_timetable_button_submit = tk.CTkButton(self, text="Вернуться назад", fg_color="#FF6347",
                                                               font=("Arial Bold", 15),
                                                               command=lambda: controller.click_back_to_main_menu_cashier())

        self.return_ticket_timetable_button_submit.pack(padx=100, pady=10)
